...
public class IsCloseToFloat extends TypeSafeMatcher<Float> {
	...
	protected boolean matchesSafely(Float aFloat) {
		return this.proxyMatcher.matchesSafely(aFloat.doubleValue());
	}
	...
	public void describeTo(Description description) {
		this.proxyMatcher.describeTo(description);
	}

	public static Matcher<Float> closeTo(float operand) {
		return IsCloseToFloat.closeTo(operand, IsCloseToFloat.DEFAULT_EPSILON);
	}
