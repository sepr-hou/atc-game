...
/**
 * Implementation of the Screen interface which sets up classes common to all
 * screens
 */
public abstract class AbstractScreen implements Screen {
	...
	public void show() {
		...
		// Setup input processor (which is probably owned by another screen
		// currently)
	...
	public void render(float delta) {
		...
		if (this.enableEscape && Gdx.input.isKeyPressed(Keys.ESCAPE)) {
			this.game.showMenu();
			return;
		}
