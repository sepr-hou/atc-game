...
public class Rectangle {
	...
	public boolean contains(Vector2D point) {
		float maxY = this.p2.getY();
		float minY = this.p1.getY();
	...
	public boolean intersects(Vector2D center, float radius) {
		/*
		 * either the center is in the rectangle or an edge of the rectangle
		 * intersects the circle if the distance between a corner and the center
		 * of the circle is less than the radius then intersection if N E S or W
		 * point of circle in rectangle then intersection
		 */
	...
	public final boolean equals(Object other) {
		...
		if (other instanceof Rectangle) {
			return this.equals((Rectangle) other);
		}
		return false;
	}
