...
public interface AirspaceObjectFactory {
	 ...
	 * 
	 * <p>
	 * This method is called every game refresh to create a game aircraft. Most
	 * of the time, this method would return {@code null} - indicating that no
	 * aircraft are to be introduced this turn.
	 * 
